...
import br.ufrpe.projetoip2.negocio.Fachada;
...
public class TelaRestauranteController {
    ...
    @FXML
    private Label lblNotaP;
    @FXML
    private Label lblNotaC;
    @FXML
    private TextArea txaDescricao;
    @FXML
    private Button btnEscreverAvaliacao;
    @FXML
    ...
    public void ExibirRestaurante() throws IOException {
        ...
        Restaurante restauranteEscolhido = fachada.getRestauranteTemp();
